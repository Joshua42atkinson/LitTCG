// blocklist.rs — Profanity filter for a children's literacy adventure
...
/// Focused on terms inappropriate for a children's literacy adventure (ages 6-16).
...
static BANNED_WORDS: &[&str] = &[
    ...
    "rape", "molest",
    "masturbat", "orgasm",
    // Drugs (contextually inappropriate for kids' adventure)
    "weed", "cocaine", "heroin",
    "meth", "crack", "lsd",
